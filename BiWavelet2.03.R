...
#                                  upperPeriod = upperPeriod)
# 
# output$LagoonWavelet <- renderPlot({wt.image(WaveletLagoon,
#                                label.time.axis=TRUE,
#               #                 useRaster = FALSE,
#                               color.key = "interval",
#                                periodlab  = "period (hours)",
...
#                                  upperPeriod = upperPeriod)
# 
# output$EtaWavelet <- renderPlot({wt.image(WaveletLagoon,
#                                label.time.axis=TRUE,
#               #                 useRaster = FALSE,
#                               color.key = "interval",
#                                periodlab  = "period (hours)",
...
output$ReconstructedTides <- renderPlot({ggplot(ReconstructedTides,aes(x=date)) +
